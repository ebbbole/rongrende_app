...
while True:  
    ...
    notice = pygame.font.SysFont("Century Gothic", 20).render("Join the RongRende", True, (0, 165, 255))
    ...
    screen.blit(notice,(50-main_text.get_width() //10, 500-main_text.get_height()))
